export default {
  ...
  contact: {
    ...
    successBody: "Je vindt antwoorden terug onder Berichten.",
    error: "Er is iets misgegaan. Probeer het opnieuw.",
    history: {
      title: "Mijn berichten",
      subtitle: "Hier zie je je eerdere berichten en de antwoorden.",
      loading: "Berichten laden…",
      empty: "Je hebt nog geen berichten gestuurd.",
      error: "Kon je berichten niet laden. Probeer de pagina te vernieuwen.",
      replyLabel: "Antwoord",
  ...
  messages: {
    title: "Berichten",
    subtitle: "Bekijk je eerdere berichten en antwoorden.",
    loading: "Berichten laden…",
    empty: "Je hebt nog geen berichten gestuurd.",
    error: "Kon je berichten niet laden. Probeer de pagina te vernieuwen.",
    replyLabel: "Antwoord",
  ...
  admin: {
    ...
    messages: {
      ...
      replyLabel: "Antwoord",
      replyPlaceholder: "Schrijf een antwoord voor deze gebruiker…",
      replySubmit: "Reageren",
      replySending: "Reageren…",
