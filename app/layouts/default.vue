...
<template>
  <div class="min-h-screen bg-gray-50 flex flex-col">
    <nav class="bg-white border-b border-gray-200 px-4 sm:px-8 py-3 flex items-center justify-between">
      <NuxtLink
        :to="user ? '/dashboard' : '/'"
      ...
      >
        <svg v-if="!mobileMenuOpen" width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
    ...
    >
      <div v-if="mobileMenuOpen" class="sm:hidden bg-white border-b border-gray-100 px-4 pb-2">
        <template v-if="user">
          <NuxtLink
            to="/dashboard"
